...
hate_model = pickle.load(open(r"hatespeech\saved_models\lr_model.pkl", 
...
violence_model = pickle.load(open(r"Violence-Detection\Pytorch-Implementation\saved_model\resnetmain.pkl", 
    "rb"))
checkpoint = torch.load(r"Violence-Detection\Pytorch-Implementation\saved_model\main_model.pt", 
